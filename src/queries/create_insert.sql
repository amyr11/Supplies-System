...
VALUES (1, 1, 20, 500000.00, '2022-08-01', 'purchase', 'delivered'),
       ...
       (3, 3, 200, 500000.00, '2022-08-03', 'sale', 'delivered'),
       (4, 4, 10, 500000.00, '2022-08-04', 'purchase', 'delivered'),
       (5, 5, 100, 50000.00, '2022-09-05', 'sale', 'delivered'),
       (6, 6, 100, 25000.00, '2022-09-06', 'purchase', 'delivered'),
       (7, 7, 100, 250000.00, '2022-09-07', 'sale', 'delivered'),
       (8, 8, 50, 125000.00, '2022-09-08', 'purchase', 'delivered'),
       (9, 9, 10, 250000.00, '2022-10-09', 'sale', 'pending'),
       (10, 10, 10, 50000.00, '2022-10-10', 'sale', 'delivered'),
       (1, 1, 25, 125000.00, '2022-10-11', 'purchase', 'delivered'),
       (2, 2, 50, 250000.00, '2022-10-12', 'purchase', 'cancelled'),
       (3, 3, 75, 375000.00, '2022-11-13', 'sale', 'delivered'),
       (4, 4, 100, 500000.00, '2022-11-14', 'purchase', 'delivered'),
       (5, 5, 150, 750000.00, '2022-11-15', 'sale', 'delivered'),
       (6, 6, 200, 1000000.00, '2022-11-16', 'purchase', 'delivered'),
       (7, 7, 250, 1250000.00, '2022-12-17', 'sale', 'pending'),
       (8, 8, 300, 1500000.00, '2022-12-18', 'purchase', 'delivered'),
       (9, 9, 350, 1750000.00, '2022-12-19', 'sale', 'delivered'),
       (10, 10, 400, 2000000.00, '2022-12-20', 'sale', 'delivered');