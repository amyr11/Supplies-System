...
VALUES ('Acme Electronics', '50-in TV', 20, -500000.00, '2022-08-01', 'purchase', 'delivered'),
       ('Furnish Co.', 'Sofa', 10, 250000.00, '2022-08-02', 'sale', 'pending'),
       (NULL, 'Jeans', -200, 500000.00, '2022-08-03', 'sale', 'delivered'),
       ('Outdoor Adventures', 'Tent', 10, 500000.00, '2022-08-04', 'sale', 'delivered'),
       ...
       ('AutoWorks', 'Car battery', 75, 187500.00, '2022-12-17', 'sale', 'delivered'),
